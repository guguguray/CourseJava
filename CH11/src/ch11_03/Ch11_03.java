...
class CStockOperation
{
	...
	public CStockOperation(String db_name, String db_table) {
		...
		try {
			...
			System.out.println("1.MYSQL 驅動程式安裝失敗!\n");
		}
		...
		try {
			...
			System.out.println("2. Connection 錯誤!\n");
		} 		
	}
...
public class Ch11_03
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		{
			System.out.println("=======================================");
			System.out.println("1.新增\t2.全部產品\t3.刪除\t4.結束:");
