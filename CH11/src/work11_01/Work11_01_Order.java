...
{		
	...
	private String d_main = "鮮烤魚排（200元）", d_second1 = "", d_second2 = "", d_dessert = "";
...
//	private JTextArea txtShow = new JTextArea("點餐資訊", 4, 80);
	...
	public ActionListener ListOK = new ActionListener()
	{
		...
		{
			if (t_table == "桌次:未選")
				JOptionPane.showMessageDialog(null, "未選『桌次』", "錯誤訊息", JOptionPane.ERROR_MESSAGE);
			else {
